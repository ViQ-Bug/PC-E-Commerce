  ...
  return (
    <View className="bg-surface rounded-3xl p-5 mb-3">
      <View className="flex-row items-center justify-between mb-4">
        ...
        {address.isDefault && (
          <View className="bg-primary px-3 py-1 rounded-full">
            <Text className="text-background text-xs font-bold">Mặc định</Text>
          </View>
        )}
      </View>
      <View className="ml-15">
        ...
        <Text className="text-text-secondary text-sm mb-2">{address.city}</Text>
      ...
      <View className="flex-row mt-4 gap-2">
        ...
        >
          <Text className="text-primary font-bold">Chỉnh sửa</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text className="text-red-500 font-bold">Xoá</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
