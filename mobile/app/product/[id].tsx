...
const ProductDetailScreen = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart(
      ...
      {
        onSuccess: () =>
          Alert.alert("Thành công", "Thêm vào giỏ hàng thành công"),
        onError: (error: any) =>
          Alert.alert(
            "Lỗi",
            error?.response.data.error || "Lỗi khi thêm vào giỏ hàng",
          ),
      },
    );
  };
